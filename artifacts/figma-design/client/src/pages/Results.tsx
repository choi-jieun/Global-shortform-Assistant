    ...
    return (
        <main className="min-h-screen bg-white [font-family:'Inter',Helvetica] text-[#2b2f36]">
            ...
            <div className="mx-auto max-w-[800px] px-[27px] pb-[72px] pt-[36px]">
                {/* ① Success heading */}
                <h1 className="text-[20px] font-semibold leading-[1.4] text-[#1e1e1e] text-center">
                    자막 · 영상제목 · 설명 · 해시태그 · 썸네일 문구를
                    만들었습니다!
                </h1>
                ...
                <div className="mt-[32px]">
                    <div className="flex items-center justify-between">
                        <h2 className="text-[22px] font-bold text-[#2b2f36]">
                            자막
                        </h2>
                        <CopyBtn
                            id="sub-all"
                    ...
                    <div className="mt-[10px] rounded-[7px] border border-[#ebedf0] overflow-hidden">
                            ...
                            <div
                                ...
                                className={[
                                    ...
                                    idx < subtitles.length - 1
                                        ? 'border-b border-[#ebedf0]'
                                        : '',
                                ].join(' ')}
                            >
                                <span className="font-mono text-[11px] text-[#767c86]">
                                    {row.time}
                                </span>
                                <span className="pr-[8px] text-[#2b2f36] leading-[1.5]">
                                    {row.ko}
                                </span>
                                <span className="text-[#2b2f36] leading-[1.5]">
                                    {row.en}
                                </span>
                            </div>
                        ))}
                        ...
                        <div className="flex items-center justify-between border-t border-[#ebedf0] bg-[#fafafa] px-[14px] py-[8px]">
                            <span className="text-[10px] text-[#767c86]">
                                총 7개 문장 · 36초
                            </span>
                ...
                <div className="mt-[36px]">
                    ...
                    <div className="mt-[12px]">
                        <p className="mb-[6px] text-[11px] font-bold text-[#767c86]">
                            추천 제목
                        </p>
                        <SectionBox>
                            ...
                            <p className="mt-[6px] text-[10px] text-[#767c86]">
                                {TITLE_NOTE}
                            </p>
                        </SectionBox>
                    </div>
                    ...
                    <div className="mt-[12px]">
                        ...
                        <SectionBox>
                            <div className="flex items-start justify-between gap-[12px]">
                                <div className="flex flex-col gap-[2px]">
                                    {BIO_LINES.map((line) => (
                                        <p
                                            key={line}
                                            className="text-[12px] text-[#2b2f36] leading-[1.6]"
                                        >
                                            {line}
                                        </p>
                                    ))}
                            ...
                            <p className="mt-[8px] text-[10px] text-[#767c86]">
                                {BIO_NOTE}
                            </p>
                        </SectionBox>
                    </div>
